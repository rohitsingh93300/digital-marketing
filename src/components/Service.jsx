  ...
  return (
    <div className='bg-gray-900 pt-10 pb-20 px-5 md:px-0'>
      <div className='max-w-7xl mx-auto'>
        <h1 className='text-center font-bold text-4xl pb-12 text-[#33CCCC] drop-shadow-md shadow-[#111111] glow dropShadow'>Our Services</h1>
        <div className='grid grid-cols-1 lg:grid-cols-4  gap-6'>
          {
            serviceJson.map((item) => {
              return <motion.div
                ...
                className='relative '>
                <div className='absolute -inset-0 blur bg-gradient-to-r bg-[#33CCCC]'></div>
